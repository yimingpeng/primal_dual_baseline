...
gym_problems = ["MountainCarContinuous", "LunarLanderContinuous", "BipedalWalker", "Pendulum"]
seeds = range(5)
...
for algorithm in algorithms:
    ...
    all_list.extend(list(map(lambda x: "".join(["qsub -t 1-10:1 ./",x.split("/")[-2], "/", x.split("/")[-1]]), all_files)))
