...
def train(env_id, num_timesteps, seed):
    from baselines.ppo_dual_rac import mlp_policy, pposgd_simple
...
def main():
    ...
    logger.configure(
                     format_strs=['stdout', 'log', 'csv'], log_suffix = "PPO_Dual_RAC-"+args.env)
    logger.log("Algorithm: PPO_Dual_RAC-"+args.env)
