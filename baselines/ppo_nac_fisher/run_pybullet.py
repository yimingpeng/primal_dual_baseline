...
def train(env_id, num_timesteps, seed):
    from baselines.ppo_nac_fisher import mlp_policy, pposgd_simple
...
def main():
    ...
    logger.configure(
                     format_strs=['stdout', 'log', 'csv'], log_suffix = "PPO_NAC_Fisher-"+args.env)
    logger.log("Algorithm: PPO_NAC_Fisher-"+args.env)
